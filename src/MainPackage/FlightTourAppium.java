...
public void AppiumSetup() throws MalformedURLException{
	...
	// Create Object of DesiredCapability class 
			...
			capabilities.setCapability(MobileCapabilityType.PLATFORM, BrowserType.IPHONE);
	                 
	                // This the version- it is important so change it if required 
			capabilities.setCapability(MobileCapabilityType.PLATFORM_NAME,"iPohne");
	                // set the browser in Emulator
			capabilities.setCapability(MobileCapabilityType.VERSION, "11.2");
